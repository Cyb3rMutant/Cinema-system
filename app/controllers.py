...
class Controller:
    ...
    def add_city(self, name, morning_price, afternoon_price, evening_price):
        match (
            self.__model.add_city(name, morning_price, afternoon_price, evening_price)
        ):
            case 1:
    ...
    def add_booking(
        ...
        if self.__model.check_customer(customer_email):
            self.__view.askquestion("customer email exists, do you want to update data")
        else:
